...
const CheckboxInput: React.FC<{ showPoints?: boolean }> = ({}) => {
    ...
    <div className="mt-3">
        ...
        <div className="row mt-2" key={index}>
          <div className="col-md-8 flex items-center">
            <div className="flex  w-full">
              <img src={checkbox} alt="circle icon" className="mr-2" />
              <input
                type="text"
      ...
      >
        <div className="flex items-center">
          <img src={checkbox} alt="circle icon" className="mr-2" />+ Add Option
        </div>
      </button>
    </div>
  );
